...
def build_env(
    ...
    *,
    ...
    inactivity_steps: int = 288,
    inactivity_penalty_bps: float = 3,
    turnover_reward_coeff: float = 0.1,
...
def main(
    ...
    best_model_files = sorted(eval_dir.glob("best_model_v2.zip"))
    if best_model_files:
...
if __name__ == "__main__":
    ...
    ap.add_argument("--features", type=str,
                    default="data/features/btc_5m_spa_v2.parquet",
                    help="Path to features parquet generated by your GA/feature script")
    ap.add_argument("--output", type=str, default="data/models/ppo_spa_btc_5m_v3",
    ...
    ap.add_argument("--inactivity_steps", type=int, default=288)
    ...
    ap.add_argument("--min_hold_steps", type=int, default=12)
